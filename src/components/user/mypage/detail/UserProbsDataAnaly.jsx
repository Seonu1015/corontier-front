...
function UserProbsDataAnaly() {
    ...
    return (
        <div className='mt-5'>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        ...
                        >
                            ...
                            <CardBody className='mx-3' style={{ marginBottom: "15px" }}>
                                <Row>
                                    <Col>
                                        <RadialChart
                                            data={chartData}
            ...
            <div>
                문제 풀이 데이터를 분석한 결과, <strong>파이썬</strong> 프로그래밍 언어에 능숙신 것으로 판단됩니다.
                <br/>
                다음과 같은 직무를 추천드립니다.
                <div style={{color:"#0489B1"}}>
                    "데이터 과학자", "백엔드 개발자", "데이터 엔지니어", "머신러닝 엔지니어", "시스템 관리자", "웹 개발자", "자동화 테스트 엔지니어"
                </div>
            </div>
